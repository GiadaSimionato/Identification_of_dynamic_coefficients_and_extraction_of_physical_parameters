...
s_rate = 0.05;   % sampling rate [s]  WAS 0.01
...
if strcmp('y',str)
    ...
    save('../Data/iden_traj/q_stacked_payload.mat', 'q_stacked');
    save('../Data/iden_traj/dq_stacked_payload.mat', 'dq_stacked');
    save('../Data/iden_traj/ddq_stacked_payload.mat', 'ddq_stacked');
    save('../Data/iden_traj/A_stacked_payload.mat', 'A_stacked');
    save('../Data/iden_traj/B_stacked_payload.mat', 'B_stacked');
    save('../Data/iden_traj/q0_stacked_payload.mat', 'q0_stacked');
