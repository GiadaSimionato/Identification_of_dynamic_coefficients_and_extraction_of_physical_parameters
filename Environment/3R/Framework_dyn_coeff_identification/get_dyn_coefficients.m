...
% Script that identifies the dynamic coefficients for a frictionless 3R
...
[tau_est, tau_real, tau_tot, timesteps] = coeff_validation(pi_r_hat, pi_r_reconstructed, Yr, tau, cat(2, params_joint_sym, p.', dh_sym, g0) , cat(2, masses_values, com_values, inertia_values, dh_values, 9.81));
