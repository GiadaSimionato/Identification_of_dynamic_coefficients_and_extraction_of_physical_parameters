...
[fm_28_1, fm_29_1] = get_behaviour(fm_28, fm_29, joint_params_sym, qk(1:50), dqk(1:50), ddqk(1:50), time_instants(1:50));
save('fm_28_1.mat', 'fm_28_1');
save('fm_29_1.mat', 'fm_29_1');