...
[fm_real_4, fm_25_4] = get_behaviour(fm_real_value, fm_25, joint_params_sym, qk(:, 151:200), dqk(:, 151:200), ddqk(:, 151:200), time_instants(:, 151:200));
save('fm_real_4.mat', 'fm_real_4');
save('fm_25_4.mat', 'fm_25_4');