...
[fm_real_1, fm_25_1] = get_behaviour(fm_real_value, fm_25, joint_params_sym, qk(:, 1:50), dqk(:, 1:50), ddqk(:, 1:50), time_instants(:, 1:50));
save('fm_real_1.mat', 'fm_real_1');
save('fm_25_1.mat', 'fm_25_1');