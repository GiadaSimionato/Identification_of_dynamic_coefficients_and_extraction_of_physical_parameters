...
[fm_real_2, fm_25_2] = get_behaviour(fm_real_value, fm_25, joint_params_sym, qk(:,51:100), dqk(:,51:100), ddqk(:,51:100), time_instants(:,51:100));
save('fm_real_2.mat', 'fm_real_2');
save('fm_25_2.mat', 'fm_25_2');