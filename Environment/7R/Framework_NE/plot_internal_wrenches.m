...
% Script that plots internal forces in 7R manipulator
...
syms g0 q1 q2 q3 q4 q5 q6 q7 dq1 dq2 dq3 dq4 dq5 dq6 dq7 ddq1 ddq2 ddq3 ddq4 ddq5 ddq6 ddq7 ...
    ...
    c4x c4y c4z c5x c5y c5z c6x c6y c6z c7x c7y c7z real
...
p_25 = load('../Data/results_sim/normal/7R_25_params.mat');
p_25 = p_25.dyn_parameters.';
p_28 = load('../Data/results_sim/normal/7R_28_params.mat');
p_28 = p_28.dyn_parameters.';
p_29 = load('../Data/results_sim/tight/7R_29_params.mat');
p_29 = p_29.dyn_parameters.';
p_32 = load('../Data/results_sim/tight/7R_32_params.mat');
p_32 = p_32.dyn_parameters.';
p_33 = load('../Data/results_sim/loose/7R_33_params.mat');
p_33 = p_33.dyn_parameters.';
p_36 = load('../Data/results_sim/loose/7R_36_params.mat');
...
% [fm_32_1, fm_33_1, fm_36_1] = get_behaviour3(fm_32, fm_33, fm_36, joint_params_sym, qk(1:50), dqk, ddqk(1:50), time_instants(1:50));
% save('fm_32_1.mat', 'fm_32_1');
% save('fm_33_1.mat', 'fm_33_1'); 
% save('fm_36_1.mat', 'fm_36_1');

fm_real_1 = load('fm_real_1.mat');
fm_real_1 = fm_real_1.fm_real_1;
fm_real_2 = load('fm_real_2.mat');
fm_real_2 = fm_real_2.fm_real_2;
fm_real_3 = load('fm_real_3.mat');
fm_real_3 = fm_real_3.fm_real_3;
fm_real_4 = load('fm_real_4.mat');
fm_real_4 = fm_real_4.fm_real_4;

fm_25_1 = load('fm_25_1.mat');
fm_25_1 = fm_25_1.fm_25_1;
fm_25_2 = load('fm_25_2.mat');
fm_25_2 = fm_25_2.fm_25_2;
fm_25_3 = load('fm_25_3.mat');
fm_25_3 = fm_25_3.fm_25_3;
fm_25_4 = load('fm_25_4.mat');
fm_25_4 = fm_25_4.fm_25_4;

fm_28_1 = load('fm_28_1.mat');
fm_28_1 = fm_28_1.fm_28_1;
fm_28_2 = load('fm_28_2.mat');
fm_28_2 = fm_28_2.fm_28_2;
fm_28_3 = load('fm_28_3.mat');
fm_28_3 = fm_28_3.fm_28_3;
fm_28_4 = load('fm_28_4.mat');
fm_28_4 = fm_28_4.fm_28_4;

fm_29_1 = load('fm_29_1.mat');
fm_29_1 = fm_29_1.fm_29_1;
fm_29_2 = load('fm_29_2.mat');
fm_29_2 = fm_29_2.fm_29_2;
fm_29_3 = load('fm_29_3.mat');
fm_29_3 = fm_29_3.fm_29_3;
fm_29_4 = load('fm_29_4.mat');
fm_29_4 = fm_29_4.fm_29_4;

fm_32_1 = load('fm_32_1.mat');
fm_32_1 = fm_32_1.fm_32_1;
fm_32_2 = load('fm_32_2.mat');
fm_32_2 = fm_32_2.fm_32_2;
fm_32_3 = load('fm_32_3.mat');
fm_32_3 = fm_32_3.fm_32_3;
fm_32_4 = load('fm_32_4.mat');
fm_32_4 = fm_32_4.fm_32_4;

fm_33_1 = load('fm_33_1.mat');
fm_33_1 = fm_33_1.fm_33_1;
fm_33_2 = load('fm_33_2.mat');
fm_33_2 = fm_33_2.fm_33_2;
fm_33_3 = load('fm_33_3.mat');
fm_33_3 = fm_33_3.fm_33_3;
fm_33_4 = load('fm_33_4.mat');
fm_33_4 = fm_33_4.fm_33_4;

fm_36_1 = load('fm_36_1.mat');
fm_36_1 = fm_36_1.fm_36_1;
fm_36_2 = load('fm_36_2.mat');
fm_36_2 = fm_36_2.fm_36_2;
fm_36_3 = load('fm_36_3.mat');
fm_36_3 = fm_36_3.fm_36_3;
fm_36_4 = load('fm_36_4.mat');
fm_36_4 = fm_36_4.fm_36_4;

fm_real = cat(3, fm_real_1, fm_real_2, fm_real_3, fm_real_4);
fm_25 = cat(3, fm_25_1, fm_25_2, fm_25_3, fm_25_4);
fm_28 = cat(3, fm_28_1, fm_28_2, fm_28_3, fm_28_4);
fm_29 = cat(3, fm_29_1, fm_29_2, fm_29_3, fm_29_4);
fm_32 = cat(3, fm_32_1, fm_32_2, fm_32_3, fm_32_4);
fm_33 = cat(3, fm_33_1, fm_33_2, fm_33_3, fm_33_4);
fm_36 = cat(3, fm_36_1, fm_36_2, fm_36_3, fm_36_4);
%% Get norm
n_joints = 7;
...
for j=1:n_joints
    for i=1:length(time_instants)-1
        ...
        forces_vect_feasible(j, i) = norm(fm_28(1:3, j, i));
        forces_vect_unfeasible(j, i) = norm(fm_36(1:3, j, i));
    end
    
end
forces_vect_real = forces_vect_real(:, 1:end-1);
forces_vect_feasible = forces_vect_feasible(:, 1:end-1);
forces_vect_unfeasible = forces_vect_unfeasible(:, 1:end-1);
%% Plot
...
for j=1:n_joints
    subplot(4,2,j)
	plot(time_instants(:,1:end-1), forces_vect_real(j, :), 'r', time_instants(:,1:end-1), forces_vect_feasible(j, :), 'b:', time_instants(:,1:end-1), forces_vect_unfeasible(j, :), 'g--');
	grid on
    xlabel('t [s]')
