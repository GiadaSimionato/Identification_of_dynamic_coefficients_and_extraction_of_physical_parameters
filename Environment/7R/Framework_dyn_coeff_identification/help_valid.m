...
pi_r_recon = double(subs(pi_r_sym, p_mod.', cat(2, masses_values, ctm_values, inertia_values)));
...
tau_est1 = load('tau_est1.mat', 'tau_est1');
tau_est1 = tau_est1.tau_est1;
tau_real1 = load('tau_real1.mat', 'tau_real1');
tau_real1 = tau_real1.tau_real1;
tau_est2 = load('tau_est2.mat', 'tau_est2');
tau_est2 = tau_est2.tau_est2;
tau_real2 = load('tau_real2.mat', 'tau_real2');
tau_real2 = tau_real2.tau_real2;
tau_est3 = load('tau_est3.mat', 'tau_est3');
tau_est3 = tau_est3.tau_est3;
tau_real3 = load('tau_real3.mat', 'tau_real3');
tau_real3 = tau_real3.tau_real3;
tau_est4 = load('tau_est4.mat', 'tau_est4');
tau_est4 = tau_est4.tau_est4;
tau_real4 = load('tau_real4.mat', 'tau_real4');
