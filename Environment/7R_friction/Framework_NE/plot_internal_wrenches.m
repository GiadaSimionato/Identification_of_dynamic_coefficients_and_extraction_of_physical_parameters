...
% Script that plots internal forces in 7R manipulator with friction
...
for j=1:n_joints
    for i=1:length(time_instants)-1
        ...
        forces_vect_feasible(j, i) = norm(fm_36(1:3, j, i));
        forces_vect_unfeasible(j, i) = norm(fm_33(1:3, j, i));
    end
end
