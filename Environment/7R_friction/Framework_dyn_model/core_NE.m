% @author Giada Simionato, 182261.
% Core part of the Newton-Euler routine.
% [Code by Claudio Gaz.]

function tau = core_NE(q, dq, ddq, g, masses,inertias, R_matrices, r_im1_i_vectors, r_i_Ci_vectors, a0,w0,w0dot,F_last,M_last)
