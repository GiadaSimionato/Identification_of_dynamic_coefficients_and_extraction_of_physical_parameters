...
[Y_stacked_21, tau_stacked_21] = get_stacked_numerical(Y_val, tau_val, q_k(:,1:147,2), dq_k(:,1:147,2), ddq_k(:,1:147,2), params_joint_sym);
save('Y21_stacked.mat', 'Y_stacked_21');
save('tau21_stacked.mat', 'tau_stacked_21');
