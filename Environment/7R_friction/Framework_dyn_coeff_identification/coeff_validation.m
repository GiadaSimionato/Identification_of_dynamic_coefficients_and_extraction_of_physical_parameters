...
function [tau_estimate, tau_model, time_instants] = coeff_validation(pi_r_hat, pi_r_recon, Yr, param_symbols, param_values)
...
if strcmp('y',str)
    discard = false;
    save('q_traj_valid.mat', 'Q');
    save('dq_traj_valid.mat', 'dQ');
    save('ddq_traj_valid.mat', 'ddQ');
    close all
end
end
...
% %     tau_model = cat(1, tau_model, tau_k);
% end
% %Y_r_stacked = Y_r_stacked(:, any(Y_r_stacked));
