...
disp('3');
% tau = expand(NE());
tau = load('dyn_model_7R_friction.mat', 'tau');
tau = expand(tau.tau);
...
[Y_stacked_22, tau_stacked_22] = get_stacked_numerical(Y_val, tau_val, q_k(:,147:295,2), dq_k(:,147:295,2), ddq_k(:,147:295,2), params_joint_sym);
save('Y22_stacked.mat', 'Y_stacked_22');
save('tau22_stacked.mat', 'tau_stacked_22');
...
% end
% legend('Estimated', 'Reconstructed');N