...
[Y_stacked_24, tau_stacked_24] = get_stacked_numerical(Y_val, tau_val, q_k(:,443:589,2), dq_k(:,443:589,2), ddq_k(:,443:589,2), params_joint_sym);
save('Y24_stacked.mat', 'Y_stacked_24');
save('tau24_stacked.mat', 'tau_stacked_24');
